 ...
 */
final class Version20190507140716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE aliment (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE boite (id INT AUTO_INCREMENT NOT NULL, stockage_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_7718EDEFDAA83D7F (stockage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE preparation (id INT AUTO_INCREMENT NOT NULL, boite_id INT DEFAULT NULL, repas_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_preparation DATE DEFAULT NULL, INDEX IDX_F9F0AAF43C43472D (boite_id), INDEX IDX_F9F0AAF41D236AAA (repas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
